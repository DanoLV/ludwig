...
# Vy
axis.plot(x1,vy,'r', linewidth = 1.0)
# Vz
axis.plot(x1,vz,'b', linewidth = 1.0)

#-------------------------------------------------------------
# VELOCIDAD DEL FLUIDO
# Vx
axis.plot(x1,vfx,'g',linestyle='dotted', linewidth = 1.0)
# Vy
axis.plot(x1,vfy,'r',linestyle='dotted', linewidth = 1.0)
# Vz
axis.plot(x1,vfz,'b',linestyle='dotted', linewidth = 1.0)
# # Vx
# axis.plot(x1,vfx,'g', linewidth = 1.0)
# # Vy
# axis.plot(x1,vfy,'r', linewidth = 1.0)
# # Vz
# axis.plot(x1,vfz,'b', linewidth = 1.0)
...
# # Vy
# axis.plot(x1,vyr,'r', linewidth = 1.0)
# # Vz
# axis.plot(x1,vzr,'b', linewidth = 1.0)
#-------------------------------------------------------------
#-------------------------------------------------------------
# VELOCIDADES EN x
# # Vx
...
# VELOCIDADES EN y
# # Vx
# axis.plot(x1,vy,'g', linewidth = 1.0)
# # Vfx
# axis.plot(x1,vfy,'r', linewidth = 1.0)
# # Vrx
# axis.plot(x1,vyr,'b',linestyle='dashed', linewidth = 1.0)
#-------------------------------------------------------------
# VELOCIDADES EN z
# # Vx
# axis.plot(x1,vz,'g', linewidth = 1.0)
# # Vfx
# axis.plot(x1,vfz,'r', linewidth = 1.0)
# # Vrx
# axis.plot(x1,vzr,'b',linestyle='dashed', linewidth = 1.0)
