...
argParser.add_argument("-i", help="input directory (default: current directory)", default=".")
...
fout_path = os.path.join(outdir, fout)
...
for i in range(0, cant + 1, paso):
    # Read data file
    archivo = os.path.join(indir, "colloids-{ciclo:08d}.csv".format(ciclo=i))
