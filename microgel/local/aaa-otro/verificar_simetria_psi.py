...
NOTAS:
  ...
  - --shell-thickness: grosor de las cáscaras esféricas. Menor grosor = más precisión pero menos puntos por cáscara
    ...
    parser.add_argument('--radial-only', action='store_true',
                       help='Solo realizar análisis radial (salta planos, componentes y métricas). Solo guarda el gráfico radial.')
    parser.add_argument('--save-csv', action='store_true',
                       help='Guardar perfiles radiales en archivos CSV (solo se aplica si se especifica -o)')
