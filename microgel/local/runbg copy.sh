...
cp plot_velocity_field.py $RESULTS_DIR/graficos
cp plot_charge_distribution.py $RESULTS_DIR/graficos
cp plot_electric_field.py $RESULTS_DIR/graficos
# cp plot_electric_field_peskin.py $RESULTS_DIR/graficos
cp plotdatos.py $RESULTS_DIR/graficos
# cp batch_plot_electric_field.py $RESULTS_DIR/graficos
cp compare_field_theory.py $RESULTS_DIR/graficos
# cp compare_field_theory_peskin.py $RESULTS_DIR/graficos
...
chmod +x $RESULTS_DIR/graficos/plot_velocity_field.py
chmod +x $RESULTS_DIR/graficos/plot_charge_distribution.py
chmod +x $RESULTS_DIR/graficos/plot_electric_field.py
# chmod +x $RESULTS_DIR/graficos/plot_electric_field_peskin.py
chmod +x $RESULTS_DIR/graficos/plotdatos.py
# chmod +x $RESULTS_DIR/graficos/batch_plot_electric_field.py
chmod +x $RESULTS_DIR/graficos/compare_field_theory.py
# chmod +x $RESULTS_DIR/graficos/compare_field_theory_peskin.py
