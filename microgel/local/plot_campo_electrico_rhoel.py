...
def plot_electric_field_rhoel(base_path, log_scale=True):
    """
    ...
    if log_scale:
        axes[0].set_yscale('symlog', linthresh=1e-20)
    ...
    if log_scale:
        axes[2].set_yscale('symlog', linthresh=1e-20)
...
if __name__ == "__main__":
    ...
    base_path = "/home/bater/Sim/ludwig/microgel/local/sim/linea peskin/single-peskin/single-peskin-plots-Lx_32_Ly_32_Lz_32/single-peskin-Lx_32_Ly_32_Lz_32"
    ...
    plot_electric_field_rhoel(base_path, log_scale=use_log_scale)
