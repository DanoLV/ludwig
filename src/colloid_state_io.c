...
int colloid_state_io_write_buf_ascii(const colloid_state_t * s, char * buf) {
  ...
  if (s == NULL || buf == NULL) {
    ...
    /* CHANGE INIT - Extra bonds for microgel polymer networks (6 bonds, intpad reduced from 7 to 3) */
    ...
    nwrite += snprintf(cbuf +  9*item, 1 + item, i1format, s->bond[0]);
    nwrite += snprintf(cbuf + 10*item, 1 + item, i1format, s->bond[1]);
    nwrite += snprintf(cbuf + 11*item, 1 + item, i1format, s->bond[2]);
    nwrite += snprintf(cbuf + 12*item, 1 + item, i1format, s->bond[3]);
    nwrite += snprintf(cbuf + 13*item, 1 + item, i1format, s->bond[4]);
    nwrite += snprintf(cbuf + 14*item, 1 + item, i1format, s->bond[5]);
    nwrite += snprintf(cbuf + 15*item, 1 + item, i1format, s->rng);
    nwrite += snprintf(cbuf + 16*item, 1 + item, i1format, s->isfixedrxyz[0]);
    nwrite += snprintf(cbuf + 17*item, 1 + item, i1format, s->isfixedrxyz[1]);
    nwrite += snprintf(cbuf + 18*item, 1 + item, i1format, s->isfixedrxyz[2]);
    nwrite += snprintf(cbuf + 19*item, 1 + item, i1format, s->isfixedvxyz[0]);
    nwrite += snprintf(cbuf + 20*item, 1 + item, i1format, s->isfixedvxyz[1]);
    nwrite += snprintf(cbuf + 21*item, 1 + item, i1format, s->isfixedvxyz[2]);
    nwrite += snprintf(cbuf + 22*item, 1 + item, i1format, s->inter_type);
    /* This is the i/o version; we ignore s->ioversion: */
    nwrite += snprintf(cbuf + 23*item, 1 + item, i1format, IO_VERSION);
    nwrite += snprintf(cbuf + 24*item, 1 + item, i1format, s->bc);
    nwrite += snprintf(cbuf + 25*item, 1 + item, i1format, s->shape);
    nwrite += snprintf(cbuf + 26*item, 1 + item, i1format, s->active);
    nwrite += snprintf(cbuf + 27*item, 1 + item, i1format, s->magnetic);
    nwrite += snprintf(cbuf + 28*item, 1 + item, i1format, s->attr);
    nwrite += snprintf(cbuf + 29*item, 1 + item, i1format, s->intpad[0]);
    nwrite += snprintf(cbuf + 30*item, 1 + item, i1format, s->intpad[1]);
    nwrite += snprintf(cbuf + 31*item, 1 + item, i1format, s->intpad[2]);
    /* CHANGE END */
...
int colloid_state_io_read_buf_ascii(colloid_state_t * s, const char * buf) {
  ...
  if (s == NULL || buf == NULL) {
    ...
    memcpy(tmp, buf +  9*sz, sz); nr += sscanf(tmp, "%d", &s->bond[0]);
    memcpy(tmp, buf + 10*sz, sz); nr += sscanf(tmp, "%d", &s->bond[1]);
    memcpy(tmp, buf + 11*sz, sz); nr += sscanf(tmp, "%d", &s->bond[2]);
    memcpy(tmp, buf + 12*sz, sz); nr += sscanf(tmp, "%d", &s->bond[3]);
    memcpy(tmp, buf + 13*sz, sz); nr += sscanf(tmp, "%d", &s->bond[4]);
    memcpy(tmp, buf + 14*sz, sz); nr += sscanf(tmp, "%d", &s->bond[5]);
    memcpy(tmp, buf + 15*sz, sz); nr += sscanf(tmp, "%d", &s->rng);
    memcpy(tmp, buf + 16*sz, sz); nr += sscanf(tmp, "%d", &s->isfixedrxyz[0]);
    memcpy(tmp, buf + 17*sz, sz); nr += sscanf(tmp, "%d", &s->isfixedrxyz[1]);
    memcpy(tmp, buf + 18*sz, sz); nr += sscanf(tmp, "%d", &s->isfixedrxyz[2]);
    memcpy(tmp, buf + 19*sz, sz); nr += sscanf(tmp, "%d", &s->isfixedvxyz[0]);
    memcpy(tmp, buf + 20*sz, sz); nr += sscanf(tmp, "%d", &s->isfixedvxyz[1]);
    memcpy(tmp, buf + 21*sz, sz); nr += sscanf(tmp, "%d", &s->isfixedvxyz[2]);
    memcpy(tmp, buf + 22*sz, sz); nr += sscanf(tmp, "%d", &s->inter_type);
    memcpy(tmp, buf + 23*sz, sz); nr += sscanf(tmp, "%d", &s->ioversion);
    memcpy(tmp, buf + 24*sz, sz); nr += sscanf(tmp, "%d", &s->bc);
    memcpy(tmp, buf + 25*sz, sz); nr += sscanf(tmp, "%d", &s->shape);
    memcpy(tmp, buf + 26*sz, sz); nr += sscanf(tmp, "%d", &s->active);
    memcpy(tmp, buf + 27*sz, sz); nr += sscanf(tmp, "%d", &s->magnetic);
    memcpy(tmp, buf + 28*sz, sz); nr += sscanf(tmp, "%d", &s->attr);
    memcpy(tmp, buf + 29*sz, sz); nr += sscanf(tmp, "%d", &s->intpad[0]);
    memcpy(tmp, buf + 30*sz, sz); nr += sscanf(tmp, "%d", &s->intpad[1]);
    memcpy(tmp, buf + 31*sz, sz); nr += sscanf(tmp, "%d", &s->intpad[2]);
    /* CHANGE END */
